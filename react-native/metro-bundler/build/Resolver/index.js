...
class Resolver {
  ...
  getModuleSystemDependencies(_ref) {
    var _ref$dev = _ref.dev; let dev = _ref$dev === undefined ? true : _ref$dev;
  ...
  resolveRequires(
    ...
    resolutionResponse.getResolvedDependencyPairs(module).
      forEach((_ref2) => {
        var _ref3 = _slicedToArray(_ref2, 2); let depName = _ref3[0], depModule = _ref3[1];
        if (depModule) {
    ...
    return dependencyOffsets.reduceRight(
      (_ref4, offset) => {
        var _ref5 = _slicedToArray(_ref4, 2); let unhandled = _ref5[0], handled = _ref5[1]; return [
...
function defineModuleCode(moduleName, code) {
  let verboseName = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : ''; let dev = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
  return [
    `__d(/* ${verboseName} */`,
