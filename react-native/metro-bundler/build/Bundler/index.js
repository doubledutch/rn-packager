...
class Bundler {
  ...
  _bundle(_ref) {
    ...
    const finalizeBundle = (_ref2) => {
      let finalBundle = _ref2.bundle, transformedModules = _ref2.transformedModules, response = _ref2.response, modulesByName = _ref2.modulesByName; return (
        ...
        this._resolverPromise.then(resolver => Promise.all(
          transformedModules.map((_ref3) => {
            let module = _ref3.module, transformed = _ref3.transformed; return (
  ...
  _buildBundle(_ref4) {
    ...
    return Promise.all(
      ...
      then((_ref5) => {
        var _ref6 = _slicedToArray(_ref5, 2); let resolver = _ref6[0], response = _ref6[1];
  ...
  getOrderedDependencyPaths(_ref9) {
    ...
    return this.getDependencies({ entryFile, dev, platform, minify, generateSourceMaps }).then(
      (_ref10) => {
        let dependencies = _ref10.dependencies;
        const ret = [];
        const promises = [];
        const placeHolder = {};
        ...
        return Promise.all(promises).then(assetsData => {
          assetsData.forEach((_ref11) => {
            let files = _ref11.files;
  ...
  _generateAssetModule(
    ...
    return Promise.all([
      ...
      then((_ref15) => {
        var _ref16 = _slicedToArray(_ref15, 2); let name = _ref16[0]; var _ref16$ = _ref16[1]; let asset = _ref16$.asset, code = _ref16$.code, meta = _ref16$.meta;
  ...
  getTransformOptions(
    ...
    var _this2 = this; return _asyncToGenerator(function* () {
      const getDependencies = function (entryFile) {
        return (
          _this2.getDependencies(_extends({}, options, { entryFile })).
            then(function (r) { return r.dependencies.map(function (d) { return d.path; }); }));
      }; const
...
function getMainModule(_ref18) {
  let dependencies = _ref18.dependencies; var _ref18$numPrependedDe = _ref18.numPrependedDependencies; let numPrependedDependencies = _ref18$numPrependedDe === undefined ? 0 : _ref18$numPrependedDe;
