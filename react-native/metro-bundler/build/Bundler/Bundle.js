...
class Bundle extends BundleBase {
  ...
  addModule(
    ...
    return resolver.wrapModule({
      ...
      then((_ref2) => {
        let code = _ref2.code, map = _ref2.map;
...
function* subtree(
  ...
  for (const _ref4 of meta.dependencyPairs || []) {
    var _ref5 = _slicedToArray(_ref4, 2); const path = _ref5[1].path;
