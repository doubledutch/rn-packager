...
class Server {
  ...
  constructor(options) {
    ...
    bundlerOpts.createModuleIdFactory = options.createModuleIdFactory;
  ...
  buildBundle(options) {
    var _this = this; return _asyncToGenerator(function* () {
      ...
      bundleDeps.set(bundle, {
        files: new Map(nonVirtual.map(function (_ref3) {
          let sourcePath = _ref3.sourcePath, meta = _ref3.meta; return (
        ...
        if (outdated.size) {
          ...
          const bundlePromise = this._bundles[optionsJson] =
            Promise.all([
              ...
              then((_ref6) => {
                var _ref7 = _slicedToArray(_ref6, 2); let response = _ref7[0], changedModules = _ref7[1];
